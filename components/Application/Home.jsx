          ...
          >
            ...
            <div className="flex flex-col flex-grow p-5">
              ...
              <div className="mt-auto flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-4 py-2"
                >
                  Add to Cart
                </button>
              </div>
